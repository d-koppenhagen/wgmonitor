<nav class="navbar navbar-default" role="navigation">
    <!-- Collect the nav links, forms, and other content for toggling -->
      <ul class="nav nav-pills pagination">
        ...
        <li id="menu1"><a href="index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
        <li id="menu2"><a href="termine.php"><span class="glyphicon glyphicon-calendar"></span> Termine</a></li>
