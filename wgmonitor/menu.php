      ...
      <ul class="nav nav-tabs nav-justified">
        ...
        <li><a href="../index.php"><span class="glyphicon glyphicon-circle-arrow-left"></span></a></li>
        <li id="menu1"><a href="index.php"><span class="glyphicon glyphicon-home"></span> LVB Info</a></li>
        <li id="menu2"><a href="timetable.php"><span class="glyphicon glyphicon-calendar"></span> Stundenplan</a></li>
		<li id="menu3"><a href="buy.php"><span class="glyphicon glyphicon-shopping-cart"></span> Einkaufsliste </a></li>
        <li id="menu5"><a href="chefkoch.php">Chefkoch </a></li>
      </ul>
